...
def salvar_ordem():
    ...
    for peca, valor, quantidade in zip(pecas, valores, quantidades):
        ...
        row_cells[1].text = f'R$ {valor_float:.2f}' if valor_float else ''
        row_cells[2].text = f'{quantidade_float:.2f}' if quantidade_float else ''
...
entry_nome_cliente = tk.Entry(aba_dados_e_servicos, width=15)
entry_telefone = tk.Entry(aba_dados_e_servicos, width=15)
entry_veiculo = tk.Entry(aba_dados_e_servicos, width=15)
entry_modelo = tk.Entry(aba_dados_e_servicos, width=15)
entry_ano = tk.Entry(aba_dados_e_servicos, width=15)
...
entry_ano.grid(row=4, column=1, padx=2, pady=2, sticky='w')
