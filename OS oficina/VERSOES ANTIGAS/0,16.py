...
tk.Button(aba_enviar, text="Enviar E-mail com PDF", command=enviar_pdf_por_email).pack(pady=5)
tk.Button(aba_enviar, text="Enviar WhatsApp com PDF", command=enviar_whatsapp).pack(pady=5)
