...
def atualizar_enviar():
    carregar_docx()  # Atualiza a lista de documentos disponíveis
    entry_numero_whatsapp.delete(0, tk.END)  # Limpa o campo de entrada do número do WhatsApp
...
icone_atualizar = carregar_icone('atualizar.png', tamanho=(24, 24))
...
# Botão para atualizar a aba "Enviar"
tk.Button(aba_enviar, text="Atualizar", image=icone_atualizar, command=atualizar_enviar).pack(pady=5)
