...
class VeiculosApp(QMainWindow):
    ...
    def setup_clientes_tab(self):
        ...
        self.btnAdicionarCliente = QPushButton('Adcionar')
        self.btnAdicionarCliente.setIcon(QIcon('icon/adicionar_cliente.png'))  # Path to your icon file
        self.btnAdicionarCliente.setToolTip('Adicionar Veículo')


        self.btnEditarCliente = QPushButton('Editar')
        self.btnEditarCliente.setIcon(QIcon('icon/editar.png'))  # Path to your icon file
        self.btnEditarCliente.setToolTip('Editar Veículo')

        self.btnExcluirCliente = QPushButton('excluir')
        self.btnExcluirCliente.setIcon(QIcon('icon/excluir_cliente.png'))  # Path to your icon file
        self.btnExcluirCliente.setToolTip('Excluir Veículo')
