import json
import sys
from PyQt5.QtWidgets import QApplication, QWidget, QVBoxLayout, QPushButton, QLineEdit, QMessageBox, QListWidget, QFormLayout, QTabWidget, QHBoxLayout
...
class VeiculosApp(QWidget):
    ...
    def setup_clientes_tab(self):
        ...
        self.tabClientesLayout.addWidget(self.btnAdicionarCliente)
        ...
        self.tabClientesLayout.addWidget(self.btnListarClientes)
        ...
        self.tabClientesLayout.addWidget(self.btnEditarCliente)
        ...
        self.tabClientesLayout.addWidget(self.btnExcluirCliente)
