...
class VeiculosApp(QMainWindow):
    ...
    def setup_veiculos_tab(self):
        ...
        self.btnAdicionarVeiculo = QPushButton()
        self.btnAdicionarVeiculo.setIcon(QIcon('icon/adicionar_cliente.png'))  # Path to your icon file
        self.btnAdicionarVeiculo.setToolTip('Adicionar Veículo')

        self.btnEditarVeiculo = QPushButton()
        self.btnEditarVeiculo.setIcon(QIcon('icon/editar_cliente.png'))  # Path to your icon file
        self.btnEditarVeiculo.setToolTip('Editar Veículo')



        self.btnExcluirVeiculo = QPushButton()
        self.btnExcluirVeiculo.setIcon(QIcon('icon/excluir_cliente.png'))  # Path to your icon file
    ...
    def setup_manutencoes_tab(self):
        ...
        # Botões
        self.btnAdicionarManutencao = QPushButton()
        self.btnAdicionarManutencao.setIcon(QIcon('icons/add.png'))  # Path to your icon file
        self.btnAdicionarManutencao.setToolTip('Adicionar Manutenção')


        self.btnEditarManutencao = QPushButton()
        self.btnEditarManutencao.setIcon(QIcon('icons/edit.png'))  # Path to your icon file
        self.btnEditarManutencao.setToolTip('Editar Manutenção')


        self.btnExcluirManutencao = QPushButton()
        self.btnExcluirManutencao.setIcon(QIcon('icons/delete.png'))  # Path to your icon file
