import json
import sys
from PyQt5.QtWidgets import QApplication, QWidget, QVBoxLayout, QPushButton, QLineEdit, QMessageBox, QListWidget, QFormLayout, QTabWidget
...
class VeiculosApp(QWidget):
    ...
    def setup_veiculos_tab(self):
        ...
        buttonLayout.addWidget(self.btnAdicionarVeiculo)
        ...
        buttonLayout.addWidget(self.btnListarVeiculos)
        ...
        buttonLayout.addWidget(self.btnEditarVeiculo)
        ...
        buttonLayout.addWidget(self.btnExcluirVeiculo)

        # Lista de Veículos
        self.listaVeiculos = QListWidget()
        self.listaVeiculos.setFixedHeight(200)  # Ajuste a altura conforme necessário

        # Adicionar layout de botões e lista ao layout da aba
        self.tabVeiculosLayout.addLayout(buttonLayout)
        self.tabVeiculosLayout.addWidget(self.listaVeiculos)
    ...
    def setup_manutencoes_tab(self):
        ...
        buttonLayout.addWidget(self.btnAdicionarManutencao)
        ...
        buttonLayout.addWidget(self.btnListarManutencoes)
        ...
        buttonLayout.addWidget(self.btnEditarManutencao)
        ...
        buttonLayout.addWidget(self.btnExcluirManutencao)

        # Lista de Manutenções
        self.listaManutencoes = QListWidget()
        self.listaManutencoes.setFixedHeight(200)  # Ajuste a altura conforme necessário

        # Adicionar layout de botões e lista ao layout da aba
        self.tabManutencoesLayout.addLayout(buttonLayout)
        self.tabManutencoesLayout.addWidget(self.listaManutencoes)
    ...
    def listar_veiculos(self):
        ...
        for veiculo in self.veiculos:
            self.listaVeiculos.addItem(f"Marca: {veiculo['marca']} - Modelo: {veiculo['modelo']} - Ano: {veiculo['ano']} - Placa: {veiculo['placa']}")
