import json
import sys
from PyQt5.QtWidgets import QApplication, QWidget, QVBoxLayout, QPushButton, QLineEdit, QLabel, QMessageBox, QListWidget, QFormLayout
...
class VeiculosApp(QWidget):
    ...
    def initUI(self):
        ...
        self.btnAdicionarCliente.setIcon(QIcon('icons/cliente.png'))  # Defina o caminho do ícone aqui
        self.btnAdicionarCliente.clicked.connect(self.adicionar_cliente)
        layout.addWidget(self.btnAdicionarCliente)

        self.btnListarClientes = QPushButton('Listar Clientes', self)
        self.btnListarClientes.setIcon(QIcon('icons/list_clients.png'))  # Defina o caminho do ícone aqui
        self.btnListarClientes.clicked.connect(self.listar_clientes)
        layout.addWidget(self.btnListarClientes)

        self.btnEditarCliente = QPushButton('Editar Cliente', self)
        self.btnEditarCliente.setIcon(QIcon('icons/edit_client.png'))  # Defina o caminho do ícone aqui
        self.btnEditarCliente.clicked.connect(self.editar_cliente)
        layout.addWidget(self.btnEditarCliente)

        self.btnExcluirCliente = QPushButton('Excluir Cliente', self)
        self.btnExcluirCliente.setIcon(QIcon('icons/delete_client.png'))  # Defina o caminho do ícone aqui
        self.btnExcluirCliente.clicked.connect(self.excluir_cliente)
        layout.addWidget(self.btnExcluirCliente)

        self.btnAdicionarVeiculo = QPushButton('Adicionar Veículo', self)
        self.btnAdicionarVeiculo.setIcon(QIcon('icons/add_vehicle.png'))  # Defina o caminho do ícone aqui
        self.btnAdicionarVeiculo.clicked.connect(self.adicionar_veiculo)
        layout.addWidget(self.btnAdicionarVeiculo)

        self.btnListarVeiculos = QPushButton('Listar Veículos', self)
        self.btnListarVeiculos.setIcon(QIcon('icons/list_vehicles.png'))  # Defina o caminho do ícone aqui
        self.btnListarVeiculos.clicked.connect(self.listar_veiculos)
        layout.addWidget(self.btnListarVeiculos)

        self.btnEditarVeiculo = QPushButton('Editar Veículo', self)
        self.btnEditarVeiculo.setIcon(QIcon('icons/edit_vehicle.png'))  # Defina o caminho do ícone aqui
        self.btnEditarVeiculo.clicked.connect(self.editar_veiculo)
        layout.addWidget(self.btnEditarVeiculo)

        self.btnExcluirVeiculo = QPushButton('Excluir Veículo', self)
        self.btnExcluirVeiculo.setIcon(QIcon('icons/delete_vehicle.png'))  # Defina o caminho do ícone aqui
        self.btnExcluirVeiculo.clicked.connect(self.excluir_veiculo)
        layout.addWidget(self.btnExcluirVeiculo)

        self.btnAdicionarManutencao = QPushButton('Adicionar Manutenção', self)
        self.btnAdicionarManutencao.setIcon(QIcon('icons/add_maintenance.png'))  # Defina o caminho do ícone aqui
        self.btnAdicionarManutencao.clicked.connect(self.adicionar_manutencao)
        layout.addWidget(self.btnAdicionarManutencao)

        self.btnListarManutencoes = QPushButton('Listar Manutenções', self)
        self.btnListarManutencoes.setIcon(QIcon('icons/list_maintenance.png'))  # Defina o caminho do ícone aqui
        self.btnListarManutencoes.clicked.connect(self.listar_manutencoes)
        layout.addWidget(self.btnListarManutencoes)

        self.btnEditarManutencao = QPushButton('Editar Manutenção', self)
        self.btnEditarManutencao.setIcon(QIcon('icons/edit_maintenance.png'))  # Defina o caminho do ícone aqui
        self.btnEditarManutencao.clicked.connect(self.editar_manutencao)
        layout.addWidget(self.btnEditarManutencao)

        self.btnExcluirManutencao = QPushButton('Excluir Manutenção', self)
        self.btnExcluirManutencao.setIcon(QIcon('icons/delete_maintenance.png'))  # Defina o caminho do ícone aqui
        self.btnExcluirManutencao.clicked.connect(self.excluir_manutencao)
        layout.addWidget(self.btnExcluirManutencao)
    ...
    def listar_clientes(self):
        ...
        for cliente in self.clientes:
            lista.addItem(f"Nome: {cliente['nome']} - RG: {cliente['rg']} - Endereço: {cliente['endereco']} - Telefone: {cliente['telefone']} - WhatsApp: {cliente['whatsapp']}")
