...
class VeiculosApp(QMainWindow):
    ...
    def setup_veiculos_tab(self):
        ...
        icon_veiculos = QIcon('icon/adicionar_veiculo.png')   # Caminho para o ícone da aba
    ...
    def setup_manutencoes_tab(self):
        ...
        icon_manutencoes = QIcon('icon/adicionar_manutencao.png')   # Caminho para o ícone da aba
